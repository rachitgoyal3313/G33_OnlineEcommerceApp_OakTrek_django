...
# List of dummy product data from original script
products_data = [
...
users_data = [
    ...
    {"username": "user3", "email": "user3@example.com", "first_name": "Robert", "last_name": "Johnson"},
    {"username": "user4", "email": "user4@example.com", "first_name": "Emily", "last_name": "Brown"},
    {"username": "user5", "email": "user5@example.com", "first_name": "Michael", "last_name": "Wilson"}
]
...
def seed_database():
    ...
    for product_data in products_data:
        # Add random rating if not provided
    ...
    for user in users:
        # Add 0-3 items to each user's cart
    ...
    for user in users:
        # Add 0-5 items to each user's wishlist
    ...
    # Create some orders (assuming Address model exists in Profile app)
    try:
        from Profile.models import Address
        
        for user in users:
            # Create 0-2 orders per user
        ...
        print("Address model not found, skipping order creation")
...
class Command(BaseCommand):
    help = 'Seed the database with products, reviews, carts, wishlists, and orders'
